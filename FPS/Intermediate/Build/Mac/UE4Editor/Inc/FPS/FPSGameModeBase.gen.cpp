...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFPSGameModeBase_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
...
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_AFPSGameModeBase_Statics::StaticCppClassTypeInfo = {
		TCppClassTypeTraits<AFPSGameModeBase>::IsAbstract,
	};
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AFPSGameModeBase_Statics::ClassParams = {
		...
		0,
		0x009002ACu,
		METADATA_PARAMS(Z_Construct_UClass_AFPSGameModeBase_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_AFPSGameModeBase_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_AFPSGameModeBase()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_AFPSGameModeBase_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(AFPSGameModeBase, 3995913702);
	template<> FPS_API UClass* StaticClass<AFPSGameModeBase>()
	{
		return AFPSGameModeBase::StaticClass();
	}
